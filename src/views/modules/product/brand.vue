        ...
        <el-table-column fixed="right" header-align="center" align="center" label="操作">
          <template slot-scope="scope">
            <el-button
              type="text"
              size="small"
              @click="deleteCateRelationHandle(scope.row.categoryId,scope.row.brandId)"
            >移除</el-button>
          </template>
        </el-table-column>
      </el-table>
...
<script>
  ...
  export default {
    ...
    deleteCateRelationHandle(categoryId, brandId) {
      this.$http({
        url: this.$http.adornUrl("/product/categorybrand/delete"),
        method: "post",
        data: this.$http.adornData({brandId:brandId,categoryId:categoryId}, false)
      }).then(({ data }) => {
        this.getCateRelation();
      });
    },
    ...
    getCateRelation() {
      this.$http({
        url: this.$http.adornUrl("/product/categorybrand/category/list"),
        method: "get",
